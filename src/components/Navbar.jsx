                ...
                <div className="max-w-7xl mx-auto h-32 px-4 sm:px-6 lg:px-8 flex justify-between items-center"> {/* Modificado */}
                    ...
                    <div className="hidden md:block">
                        <ul className="ml-4 flex items-center space-x-9">
                            ...
                            <li><Link to="/add" className="text-white hover:text-teal-500 font-bold text-lg">Crear nueva publicacion</Link></li>
                            <li><a href="#" className="text-white hover:text-teal-500 font-bold text-lg">Acerca de</a></li>
                            <li><Link to="https://github.com/Areyes2019092" target='_blank' className="text-white hover:text-teal-500 font-bold text-lg">Sobre mi</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-gray-800 h-full w-64 flex flex-col justify-between">
                        <div className="pt-4 px-4">
                            <div className="flex justify-between items-center">
                                <div>
                                    <a href="#" className="text-2xl font-bold text-white ml-4">Mi blssog</a>
                                </div>
                                <div>
                            ...
                            <div className="px-2 pt-2 pb-3 mt-8 space-y-1">
                                <Link to="/" className="block text-white hover:bg-gray-700 px-3 py-2 rounded-md">Inicsssio</Link>
                                <Link to="/add" className="block text-white hover:bg-gray-700 px-3 py-2 rounded-md">Blosssg</Link>
                                <a href="#" className="block text-white hover:bg-gray-700 px-3 py-2 rounded-md">Acerca de</a>
                                <Link to="https://github.com/Areyes2019092" className="block">Sobre mi</Link>
                            </div>
                        </div>
                    </div>
                </div>
